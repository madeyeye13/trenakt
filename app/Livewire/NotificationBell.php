...
class NotificationBell extends Component
{
    ...
    public function urlFor(DatabaseNotification $notification): ?string
    {
        ...
        return match ($data['type'] ?? null) {
            ...
            'task_submission_received', 'submission_reward_forfeited_alert' => route('admin.submissions.index'),
            'task_approved', 'task_rejected', 'task_approved_reward_pending', 'reward_forfeited' => route('tasks.index'),
            'withdrawal_processed', 'withdrawal_failed' => route('earnings.index'),
            'referral_reward_earned', 'reward_released' => route('earnings.index'),
